...
import 'package:todo_list/Keys/checkable_todo_item.dart';
// import 'package:todo_list/keys/todo_item.dart';
          ...
          child: Column(
            children: [
              ...
              for (final todo in _orderedTodos)
                CheckableTodoItem(
                  key: ObjectKey(todo),    //or you can even pass ValueKey(anyvalue....associated with that object)
                  todo.text,
                  todo.priority,
                ),
            ],
